...
public class Telephone
{
    ...
    public Telephone()
    {
        ...
        JScrollPane speakerPane = new JScrollPane(speakerField, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
        speakerPanel.add(speakerPane);
        ...
        JScrollPane microphonePane = new JScrollPane(microphoneField);
        ...
        microphonePanel.add(microphonePane);
        ...
        JScrollPane micoPane = new JScrollPane(microphoneField, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
        microphonePanel.add(micoPane);
